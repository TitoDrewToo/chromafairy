...
export default async function ArchivedInquiriesPage() {
  ...
  return <div className="admin-dashboard admin-operations-page"><p className="admin-eyebrow">Studio archive</p><h1>Archived inquiries</h1><p className="admin-muted">Past leads remain here until you restore them to the active inbox.</p><Hint id="inquiryArchive"><Link className="admin-archive-link" href="/studio/inquiries">← Back to active inquiries</Link></Hint><InquiryAdmin archived initialInquiries={rows} /></div>;
}
