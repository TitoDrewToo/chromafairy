...
export default async function AdminUsersPage() {
  ...
  const { data: canManageUsers } = await supabase.rpc("is_user_manager");
  if (!canManageUsers) return <AdminMessage message="Only owners, developers, and admins can manage users." />;
