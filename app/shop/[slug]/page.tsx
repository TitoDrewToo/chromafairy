      ...
      <div className="shop-frame shop-product">
        ...
        <div className="shop-product-layout">
          <div className="shop-gallery">
            {gallery.length ? gallery.map((image, index) => <div className="shop-gallery-frame" key={image.storage_path}><ShopImage alt={image.alt ?? work.title} fetchPriority={index === 0 ? "high" : "auto"} loading={index === 0 ? "eager" : "lazy"} src={image.storage_path} /></div>) : <div className="shop-gallery-frame"><ShopImage alt={work.title} /></div>}
          </div>
